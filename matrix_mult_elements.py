...
def parallel_matrix_multiplication_with_intermediate_v2(matrix_a, matrix_b, intermediate_file, result_file, num_processes=4):
    """Перемножает матрицы с использованием промежуточного файла."""
...
if __name__ == "__main__":
    ...
    parallel_matrix_multiplication_with_intermediate_v2(
        matrix_a,
        matrix_b,
        intermediate_file="intermediate_file.txt",
        result_file="intermediate_result_matrix.txt",
        num_processes=4
    )
